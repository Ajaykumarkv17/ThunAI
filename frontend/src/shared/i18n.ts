...
const DICTIONARIES: Record<LanguageCode, Dictionary> = {
  en: {
    ...
    'responder.action.en-route': 'En route',
    'responder.action.on-scene': 'On scene',
    'responder.action.completed': 'Completed',
    'responder.state.AWAITING_ACK': 'Awaiting your acknowledgement',
    'responder.state.ACCEPTED': 'Accepted',
    'responder.state.EN_ROUTE': 'En route',
    'responder.state.ON_SCENE': 'On scene',
    'responder.state.VERIFICATION': 'Completed — awaiting coordinator verification',
  ...
  ta: {
    ...
    'responder.action.en-route': 'வழியில்',
    'responder.action.on-scene': 'இடத்தில்',
    'responder.action.completed': 'முடிந்தது',
